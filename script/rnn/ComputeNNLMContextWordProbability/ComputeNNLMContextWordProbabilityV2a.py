"""
This is memory intense version.
"""
...
def main():
	...
	for context_window_size in range(0, 9):
		...
		for context_ids in log_s_table_context_word:
			...
			'''
			print(context_ids, log_E_n_ge1_context[context_ids])
			...
			for context_ids in log_s_table_context_word:
				...
				for word_id in id_to_word:
					...
					if context_ids == (24,):
						...
						print(word_id, id_to_word[word_id], log_E_c_context_word[context_ids][word_id],
						      log_E_c_context[context_ids])
					'''
				...
				'''
				print(context_ids, log_E_c_context[context_ids])
